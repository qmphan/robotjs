...
NAN_METHOD(moveMouse)
{
	...
	size_t x = info[0]->Int32Value(Nan::GetCurrentContext()).ToChecked();
	size_t y = info[1]->Int32Value(Nan::GetCurrentContext()).ToChecked();
...
NAN_METHOD(mouseClick)
{
	...
	if (info.Length() > 0)
	{
		v8::String::Utf8Value bstr(v8::Isolate::GetCurrent(), info[0]->ToString(Nan::GetCurrentContext()).ToLocalChecked());
		const char * const b = *bstr;
...
NAN_METHOD(setMouseDelay)
{
	...
	mouseDelay = info[0]->Int32Value(Nan::GetCurrentContext()).ToChecked();
...
NAN_METHOD(scrollMouse)
{
	...
	int x = info[0]->Int32Value(Nan::GetCurrentContext()).ToChecked();
	int y = info[1]->Int32Value(Nan::GetCurrentContext()).ToChecked();
...
{
	v8::String::Utf8Value fstr(v8::Isolate::GetCurrent(), value->ToString(Nan::GetCurrentContext()).ToLocalChecked());
...
NAN_METHOD(keyTap)
{
	...
	v8::String::Utf8Value kstr(v8::Isolate::GetCurrent(), info[0]->ToString(Nan::GetCurrentContext()).ToLocalChecked());
	k = *kstr;
...
NAN_METHOD(typeStringDelayed)
{
	...
	size_t cpm = info[1]->Int32Value(Nan::GetCurrentContext()).ToChecked();
...
NAN_METHOD(setKeyboardDelay)
{
	...
	keyboardDelay = info[0]->Int32Value(Nan::GetCurrentContext()).ToChecked();
...
NAN_METHOD(captureScreen)
{
	...
	if (info.Length() == 4)
	{
		...
		x = info[0]->Int32Value(Nan::GetCurrentContext()).ToChecked();
		y = info[1]->Int32Value(Nan::GetCurrentContext()).ToChecked();
		w = info[2]->Int32Value(Nan::GetCurrentContext()).ToChecked();
		h = info[3]->Int32Value(Nan::GetCurrentContext()).ToChecked();
	}
	else
	{
...
BMP buildBMP(Local<Object> info)
{
	...
	img.width = obj->Get(Nan::New("width").ToLocalChecked())->Uint32Value(Nan::GetCurrentContext()).ToChecked();
	img.height = obj->Get(Nan::New("height").ToLocalChecked())->Uint32Value(Nan::GetCurrentContext()).ToChecked();
	img.byteWidth = obj->Get(Nan::New("byteWidth").ToLocalChecked())->Uint32Value(Nan::GetCurrentContext()).ToChecked();
	img.bitsPerPixel = obj->Get(Nan::New("bitsPerPixel").ToLocalChecked())->Uint32Value(Nan::GetCurrentContext()).ToChecked();
	img.bytesPerPixel = obj->Get(Nan::New("bytesPerPixel").ToLocalChecked())->Uint32Value(Nan::GetCurrentContext()).ToChecked();
...
NAN_METHOD(getColor)
{
	...
	size_t x = info[1]->Int32Value(Nan::GetCurrentContext()).ToChecked();
	size_t y = info[2]->Int32Value(Nan::GetCurrentContext()).ToChecked();
